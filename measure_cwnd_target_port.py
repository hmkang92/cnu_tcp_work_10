...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--time', type=int, default=15, help='Measurement time')
    parser.add_argument('-p', '--port', type=int, required=True, help='Measurement port')
    parser.add_argument('-s', '--sleep', type=int, default=0, help='Sleep time')
    parser.add_argument('-o', '--output', type=str, default='output.csv', help='Output csv file path')
